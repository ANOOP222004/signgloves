...
class RecorderPanel(QGroupBox):
    ...
    def _set_voice_btn_on(self):
        """Style the voice button green to show it is active."""
        self._voice_btn.setText("🎤  Voice ON")
        self._voice_btn.setStyleSheet(
            "QPushButton { background-color: #ccffcc; color: #006600; "
            "font-weight: bold; border: 1px solid #006600; border-radius: 4px; }"
        )

    def _set_voice_btn_off(self):
        """Style the voice button to show it is inactive (system default)."""
